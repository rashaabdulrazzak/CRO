...
import "./chunk-RAKGFBCR.js";
import "./chunk-CE2XNH73.js";
...
var FileUpload = React7.memo(React7.forwardRef(function(inProps, ref) {
  ...
  var createBasic = function createBasic2() {
    ...
    var label = props.auto ? chooseLabel : React7.createElement("span", labelProps, hasFiles ? props.selectedFileLabel || filesState[0].name : chooseLabel);
    var chooseIconProps = mergeProps({
      className: cx("chooseIcon", {
