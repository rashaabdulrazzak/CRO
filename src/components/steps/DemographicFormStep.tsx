...
// Ensure validation normalizes and uppercases the volunteer code
...
const DemographicFormStep: React.FC<DemographicFormStepProps> = ({
  demographic,
  setDemographic,
  generateVolunteerId,
}) => (
    ...
    <div>
      ...
      <div className="flex gap-2">
        ...
        <Button
          ...
          className="shrink-0 p-button p-button-secondary"
        />
      </div>
    ...
    <div>
      ...
      <Calendar
        ...
        onChange={(e) =>
          setDemographic((prev) => ({
            ...prev,
            visitDate: (e.value as Date) ?? null,
          }))
        }
        className="w-full"
    ...
    <div>
      ...
      <Calendar
        ...
        onChange={(e) =>
          setDemographic((prev) => ({
            ...prev,
            birthDate: (e.value as Date) ?? null,
          }))
        }
        className="w-full"
        inputClassName="w-full"
